...
<head>
    <meta charset="utf-8">
    <title>INSCRIPTION SALON SAVM 2023</title>
    <link rel="stylesheet" href="styles1.css">
</head>
 <!-- Verson du 05.03 � 17:44 --> 
<body>
    <div class="img-container"> <!-- Block parent element -->
        <img src=banniereSAVM.jpg width=600px align=hcenter>
        <H2>INSCRIPTION SALON SAVM 2023</H2>
        <label for="md">Exposition du  30 SEPTEMBRE au 22 OCTOBRE 2023 à 17h</label><BR><br>
    </div>
    ...
    <form action = "helloUpload" method = "post" enctype = "multipart/form-data">
        ...
        <fieldset>
            ...
            <p>
                <label class="label" for="contact_nom">Nom / Pseudo<span class="obligatoire">*</span></label>
        ...
        <fieldset>
            ...
            <p>
                ...
                <input id="num" type="text" name="ADR_NUM" size="10"  title="numéro : 33 Bis par exemple" required>
            </p>
            <p>
            ...
            <p>
                ...
                <input id="cp" type="text" maxlength="5" name="ADR_CODE_POSTAL" size="10" placeholder="5 chiffres" pattern="[0-9]{5}" title="nombre de 5 chiffres" required>                
            </p>
        ...
        <fieldset>
            ...
            <p>
                <label  for="rue">Remarques particulières à l'exposition de l'œuvre   </label>
                <textarea id="OEUVRE_DETAIL_EXPO" rows="3" cols="60" placeholder="Remarques particulières  (3 lignes max)"  name="OEUVRE_DETAIL_EXPO" maxlength = "180"></textarea> 
            </p>
            ...
            <p class="margel">ADAGP
                <input type="radio" value="oui" id="md1" name="ADAGP" >
                <label for="md">oui</label>
                <input type="radio" value="non" id="ms1" name="ADAGP" checked>
...
"SAVM Ateliers d'Art 5 ter, avenue du Bac 94210 La Varenne Saint Hilaire" avec enveloppe de retour.
            ...
            <p>                
                ...
                <A href="http://davic.mkdh.fr/savm-data/reglementsSAVM2023.pdf" target="Reglements SAVM"> Téléchargement <img height="30" width="30" src="pdf2.png"></A>
            </p>
