...
<body>
    <div class="img-container"> <!-- Block parent element -->
        ...
        <H2>INSCRIPTION SALON SAVM 2024</H2>
        <label for="md">Exposition du 28 septembre au 20 octobre  2024 à 17h</label><BR><br>
    </div>

    <form action = "helloUpload" method = "post" enctype = "multipart/form-data" accept-charset="utf-8">
	    ...
	    -->
	    <input type="hidden" value="non" id="md1" name="DISPO_GARDE" >
